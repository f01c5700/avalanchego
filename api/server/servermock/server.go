...
// Source: github.com/f01c5700/avalanchego/api/server (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -package=servermock -destination=api/server/servermock/server.go -mock_names=Server=Server github.com/f01c5700/avalanchego/api/server Server
//
